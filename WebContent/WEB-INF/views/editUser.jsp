...
<title>Deal with IT | Edit Profile</title>
						...
						<div class="panel panel-primary" data-collapsed="0">
							...
							<div class="panel-body">
								...
								<form role="form"
									...
									method="post" action="editUser" onsubmit="return passVal()"1>
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="firstName"
												value="${user.firstName}" data-validate="maxlength[30]"
												required />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="lastName"
												value="${user.lastName}" data-validate="maxlength[30]"
												required />
										</div>
									</div>
