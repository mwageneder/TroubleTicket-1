...
<title>Deal with IT | Edit Ticket</title>
						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal form-groups-bordered validate"
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input class="form-control" type="text" name="owner" readonly
											value="<c:out value="${ticket.owner.username}"/>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" name="subject" placeholder="Title"
											value="${ticket.subject}" data-validate="maxlength[30]" required />
									</div>
								</div>
										...
										<div class="col-sm-5">
											...
											<sec:authorize access="hasAnyRole('ROLE_ADMIN', 'ROLE_SUPPORT')">
												...
												<input type="text" class="form-control size-1" id="priority"
													value="${ticket.priority}" data-min="1" data-max="10"
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<textarea class="form-control" rows="8" name="description"
											readonly placeholder="<c:out value="${ticket.description}"/>"></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-sm-offset-3 col-sm-5">
										<button type="submit"
											class="btn btn-save">
											<i class="entypo-floppy"></i>&nbsp;&nbsp;<strong>Save</strong>
										</button>
									</div>
								</div>
							</form>
