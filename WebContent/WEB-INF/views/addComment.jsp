...
<title>Deal with IT | Create Comment</title>
						...
						<div class="panel panel-primary" data-collapsed="0">
							...
							<div class="panel-body">
								...
								<form class="form-horizontal form-groups-bordered validate"
									action="addComment?id=${ticket.id}&${_csrf.parameterName}=${_csrf.token}"
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input class="form-control" name="currentUser" readonly
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<textarea class="form-control" name="content"
												placeholder="max. 500 characters" rows="8" required
									...
									<div class="form-group">
										<div class="col-sm-offset-3 col-sm-5">
											...
											<button type="submit" class="btn btn-save">
												<i class="entypo-floppy"></i>&nbsp;&nbsp;Save Comment
											</button>
